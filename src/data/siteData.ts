...
export const siteData = {
  ...
  projects: [
    ...
    },
    {
      ...
      number: "02",
      title: "TinyNPU",
      subtitle: "End-to-End Neural-Network Inference Accelerator",
      technologies: ["Python", "INT8 Quantization", "SystemVerilog", "FPGA"],
      timeline: "2026",
      summary: "A complete ML-to-hardware pipeline that trains, quantizes, and verifies a compact neural-network inference accelerator for FPGA deployment.",
      details: {
        overview: "TinyNPU demonstrates how a trained 21 → 14 → 7 → 1 neural network moves from Python training and INT8/INT32 quantization into a verified SystemVerilog RTL accelerator.",
        architecture: [
          "Python FP32 training with backpropagation and binary cross-entropy",
          "Per-layer INT8 weights and INT32 accumulators with fixed-point requantization",
          "SystemVerilog MAC, ReLU, neuron, layer, and complete TinyNPU modules",
          "Icarus Verilog simulation flow targeting FPGA-ready inference hardware"
        ],
        highlights: [
          "Hierarchical RTL verification passed from MAC and ReLU units through full network integration.",
          "Python quantized inference provides the reference for the next real-model RTL comparison."
        ],
        outcomes: [
          "Created a reproducible software-to-hardware path from trained model to exported .mem parameters."
        ]
      },
